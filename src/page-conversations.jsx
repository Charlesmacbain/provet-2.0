  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0, display: "flex", flexDirection: "column", gap: 2 }}>
        <div style={{
          fontSize: 13, fontWeight: 500, color: "var(--n-color-text)",
          overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap",
        }}>
          {t.title}
        </div>
        <div style={{
          fontSize: 12, color: "var(--linear-faint)",
          overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap",
        }}>
          {t.preview}
        </div>
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 4, flex: "none" }}>
        ...
        <span style={{ fontSize: 11, color: "var(--linear-faint)", fontFeatureSettings: "'tnum' 1" }}>{t.time}</span>
      </div>
    </button>
  );
}
...
function ConvDetailHeader({ t }) {
  return (
    <div style={{
      ...
      <span style={{ fontSize: 13, color: "var(--linear-faint)", fontFeatureSettings: "'tnum' 1" }}>{t.code}</span>
      <span style={{ fontSize: 13, color: "var(--n-color-text)", fontWeight: 500 }}>{t.title}</span>
...
function ConvActivityItem({ ev }) {
  if (ev.kind === "system") {
    return (
      <div style={{ display: "flex", alignItems: "center", gap: 8, color: "var(--linear-faint)", fontSize: 12 }}>
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
      <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
        ...
        <span style={{ fontSize: 13, fontWeight: 500, color: "var(--n-color-text)" }}>{ev.who}</span>
        <span style={{ fontSize: 12, color: "var(--linear-faint)" }}>{ev.time}</span>
      </div>
      <div style={{
        fontSize: 13, color: "var(--n-color-text)", lineHeight: 1.55,
        paddingLeft: 28,
      }}>
    ...
    <div className="conv-detail__scroll">
      <div className="conv-detail__inner">
        ...
        <div style={{ marginTop: 22, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div style={{ fontSize: 13, fontWeight: 500, color: "var(--n-color-text)" }}>Activity</div>
          <div style={{ display: "flex", alignItems: "center", gap: 8, color: "var(--linear-faint)", fontSize: 12 }}>
...
function ConversationsPage() {
  ...
  return (
    <div className="linear-page conv-page" style={{ display: "flex", flexDirection: "column", height: "100%" }}>
      {/* (no large page header; matches Linear inbox where the list & detail have their own headers) */}
